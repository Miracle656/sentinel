/**
 * Features Component - Feature grid section
 */
import React from 'react';
import { Zap, Brain, GitBranch, Wrench, Star, Shield } from 'lucide-react';
            ...
            <div className="container mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-bold mb-4">
                        Why Choose <span className="text-[#0284FE]">Sentinel</span>?
                    </h2>
                    ...
                    {features.map((feature, index) => (
                        <Card key={index} hover className="group">
                            <div className="flex flex-col h-full">
                                <div className="w-12 h-12 rounded-lg bg-[#0284FE]/10 border border-[#0284FE]/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                    <feature.icon className="w-6 h-6 text-[#0284FE]" />
                                </div>
